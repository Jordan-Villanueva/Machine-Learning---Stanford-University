...
% Convert y to a matrix of binary vectors
y_matrix = eye(num_labels)(y,:);

% Compute the unregularized cost function
J = (1 / m) * sum(sum(-y_matrix .* log(h_theta) - (1 - y_matrix) .* log(1 - h_theta)));

% Add regularization term to the cost function (excluding bias terms)
...
% Add regularization term to the gradients (excluding bias terms)
